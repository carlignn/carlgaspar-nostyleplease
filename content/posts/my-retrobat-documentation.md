---
title: My Retrobat Documentation
subtitle: (With a little bit of RetroArch)
draft: false
...
## Roms
All roms will be stored in the NAS.

## Symbolic links
[Symbolic links](https://wiki.retrobat.org/tutorials/symbolic-links) will be used in Retrobat for the roms to connect to the NAS.

## BIOS
Default BIOS will be stored in the NAS. (RetroArch on a different folder).
